...
void MenuScene::init() {
	MenuSceneUI tmp = MenuSceneUI("button","Assets/Loading/startWhite.png", 200, 50, ((Game::camera.w / 2) - (200 / 2)), ((Game::camera.h / 2) - (50 / 2)), 691, 150);
	uiComponents.push_back(tmp);

	title = TextureManager::LoadTexture("Assets/Loading/TitleWhite.png");
	destTitle.w = 800;
	destTitle.h = 124;
